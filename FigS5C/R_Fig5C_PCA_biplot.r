...
#---Initializing:  setting all names, sizes, colors, read in data etc.: #####			
	...
	model_name <- "06_hELISAS_Donor_COPD_conc_tprotNorm_OEME_LOG_0quarterofmin_replaced_cohort1"
	...
	output_folder <- paste0(statisticsfilepath,"output_FigS5C/")
...
#---Export Bi-plots: ######			    	
  ...
  ggsave(paste0(output_folder, model_name,"__cPCA_PC13_biplot.pdf"),plot = Biplot_cPCA_PC23 , device = pdf(), width=w+5, 
         height=h+7, units = "mm", dpi = 900); dev.off()
