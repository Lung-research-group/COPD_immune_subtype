...
final_data <- read.csv(file ="/home/isilon/users/o_syarif/COPD machine learning/COPD_paper/Fig5/revision_iScience/script/final_revision/Fig2I_J/input data/final_data_revSC_COPDvsDonor.csv")
...
parameter <- read_xlsx("/home/isilon/users/o_syarif/COPD machine learning/COPD_paper/Fig5/revision_iScience/script/final_revision/Fig2I_J/input data/parameter_label.xlsx") # it should be easily found inside the data folder. Here inside the parameter label and the corresponding labels
