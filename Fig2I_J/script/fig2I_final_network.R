...
a <- ggplot(df, aes(x=CXCL9_L, y=CD8)) + 
  geom_point(color="#791812", size=4)+
  geom_smooth(method="lm")+ylab(expression("CD8"^"+"))+xlab("CXCL9")+
  theme(strip.text.x = element_text(size = 18),
        axis.text.x = element_text(size = 18, angle = 0, hjust = 1, vjust = 1),
        axis.text.y = element_text(size = 18),
        axis.title = element_text(size = 18),
...
a <- ggplot(df, aes(x=CD8, y=pCO2_mmHg)) + 
  geom_point(color="#791812", size=4)+
  geom_smooth(method="lm")+xlab(expression("CD8"^"+"))+ylab(expression("pCO"[2]))+
  theme(strip.text.x = element_text(size = 18),
        axis.text.x = element_text(size = 18, angle = 0, hjust = 1, vjust = 1),
        axis.text.y = element_text(size = 18),
        axis.title = element_text(size = 18),
...
ggsave(file = "multipanel_nmf13vsnmf20.png",plot=p2,device = "png",scale=0.9,
