...
save_plot(paste0("plots/", Sys.Date(), "_scRNA_scrna.df_violin1", ".png"), 
          plot = p1, base_height = 4.5, base_width = 12, dpi = 300)
...
patch
save_plot(paste0("plots/", Sys.Date(), "_scRNA_scrna.df_violin", ".png"), 
          plot = patch, base_height = 12, base_width = 10, dpi = 300)
